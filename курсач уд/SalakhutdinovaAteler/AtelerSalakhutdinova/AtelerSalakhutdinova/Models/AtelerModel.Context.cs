...
namespace AtelerSalakhutdinova.Models
{
    ...
    public partial class AtelierEntities : DbContext
    {
        ...
        public DbSet<Аксессуары> Аксессуары { get; set; }
        public DbSet<Бухгалтерия> Бухгалтерия { get; set; }
        public DbSet<Выкройки> Выкройки { get; set; }
        public DbSet<Доставка> Доставка { get; set; }
        public DbSet<Заказ> Заказ { get; set; }
        public DbSet<ЗаписьНаМерку> ЗаписьНаМерку { get; set; }
        public DbSet<Клиент> Клиент { get; set; }
        public DbSet<Мерки> Мерки { get; set; }
        public DbSet<Оборудование> Оборудование { get; set; }
        public DbSet<СведенияОТканях> СведенияОТканях { get; set; }
        public DbSet<Скидка> Скидка { get; set; }
        public DbSet<СкладТканей> СкладТканей { get; set; }
        public DbSet<Состояние> Состояние { get; set; }
